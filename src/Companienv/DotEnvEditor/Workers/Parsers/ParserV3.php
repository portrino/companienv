...
class ParserV3 extends Parser implements ParserInterface
{
     ...
     */
    protected function parseSetterData(?string $data = null): array
    {
        ...
        $result = array_reduce($dataChars, function (array $parseInfo, string $char) use ($data) {
            switch ($parseInfo[2]) {
                ...
                case self::ESCAPE_SEQUENCE_STATE:
                    ...
                    throw new InvalidValueException(self::getErrorMessage('an unexpected escape sequence', $data), 1720796720);
                ...
                case self::WHITESPACE_STATE:
                    ...
                    if (!ctype_space($char)) {
                        throw new InvalidValueException(self::getErrorMessage('unexpected whitespace', $data), 1720796721);
                    }
        ...
        if (in_array($result[2], [
            ...
            throw new InvalidValueException($this->getErrorMessage('a missing closing quote', $data), 1720796723);
        }
